...
public class TextCell extends FrameLayout {
    ...
    public void setColorfulIcon(int colorTop, int colorBottom, int resId) {
        ...
        imageView.setImageResource(resId);
        imageView.setColorFilter(new PorterDuffColorFilter(Theme.isFlintGramBlueThemeActive() ? 0xFF132D5E : Color.WHITE, PorterDuff.Mode.SRC_IN));

        if (Theme.isFlintGramBlueThemeActive()) {
            colorTop = colorBottom = 0xFFAEC2F4;
        }
