...
//            }
    ...
    public void loadEmojiThemes() {
        ...
        previewItems.add(new ChatThemeBottomSheet.ChatThemeItem(EmojiThemes.createFlintGramPreviewTheme(currentAccount, "Flintgram basic", "\uD83C\uDF31")));
        previewItems.add(new ChatThemeBottomSheet.ChatThemeItem(EmojiThemes.createFlintGramPreviewTheme(currentAccount, "Flintgram Extended", "\uD83C\uDF3F")));
        previewItems.add(new ChatThemeBottomSheet.ChatThemeItem(EmojiThemes.createFlintGramPreviewTheme(currentAccount, "Material Ocean", "\uD83C\uDF0A")));
        for (int i = 0; i < count; ++i) {
    ...
    public void generateEmojiPreviewThemes(final ArrayList<TLRPC.TL_theme> emojiPreviewThemes, int currentAccount) {
        ...
        if (!emojiPreviewThemes.isEmpty()) {
            ...
            defaultEmojiThemes.clear();
            defaultEmojiThemes.add(new ChatThemeBottomSheet.ChatThemeItem(EmojiThemes.createFlintGramPreviewTheme(currentAccount, "Flintgram basic", "\uD83C\uDF31")));
            defaultEmojiThemes.add(new ChatThemeBottomSheet.ChatThemeItem(EmojiThemes.createFlintGramPreviewTheme(currentAccount, "Flintgram Extended", "\uD83C\uDF3F")));
            defaultEmojiThemes.add(new ChatThemeBottomSheet.ChatThemeItem(EmojiThemes.createFlintGramPreviewTheme(currentAccount, "Material Ocean", "\uD83C\uDF0A")));
            NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.emojiPreviewThemesChanged);
        }
    }
