...
public class LocaleController {
    ...
    private String getStringInternal(String key, String fallback, int fallbackRes, int res) {
        ...
        return replaceBrandName(key, value);
    }

    private static String replaceBrandName(String key, String value) {
        if (value == null) {
            return null;
        }
        ...
        return value.replace("Telegram", "Flintgram");
    }

    private static String replaceBrandName(String value) {
        return replaceBrandName(null, value);
    }
    ...
    public static String formatString(String key, String fallback, int res, int fallbackRes, Object... args) {
        try {
            ...
            if (getInstance().currentLocale != null) {
                return replaceBrandName(key, String.format(getInstance().currentLocale, value, args));
            } else {
                return replaceBrandName(key, String.format(value, args));
            }
        } catch (Exception e) {
            FileLog.e(e);
            return "LOC_ERR: " + key;
    ...
    public static CharSequence formatSpannable(String key, String fallback, int res, int fallbackRes, Object... args) {
        try {
            ...
            SpannableStringBuilder builder = new SpannableStringBuilder(replaceBrandName(key, value));
